  ...
  return (
    <div className={`w-64 bg-[#0B4F6C] text-white flex flex-col h-full ${className}`}>
      ...
      <div className="p-4 border-t border-white/10">
        <button className="w-full bg-red-500 text-white py-3 rounded-lg hover:bg-red-600 transition-all duration-200 flex items-center justify-center gap-2 font-medium shadow-md hover:shadow-lg transform hover:-translate-y-0.5">
