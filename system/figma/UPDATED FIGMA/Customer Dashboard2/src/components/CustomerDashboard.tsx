  ...
  return (
    <div className="p-3 md:p-8">
      ...
      <div className="mb-4 md:mb-8">
        <h1 className="text-[#1A5560] mb-1 text-xl md:text-3xl">Welcome, Maria Santos!</h1>
        <p className="text-[#1A5560]/70 text-xs md:text-base">Here's an overview of your appointments.</p>
      </div>
